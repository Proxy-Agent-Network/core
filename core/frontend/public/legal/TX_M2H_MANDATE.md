...
**Version:** 2026.3.0 (Austin Pilot \- Draft)

**Jurisdiction:** State of Texas / TX Transp Code § 545.454 (Automated Motor Vehicles)
...
This mandate grants the Agent explicit, limited authority to perform physical actions on the Asset's exterior strictly necessary to clear the following Unified Diagnostic Service (UDS) fault, in compliance with TxDOT incident management guidelines:
...
* \[ \] **Perimeter Clear:** Removal of non-hazardous physical debris or vandalism obstructing the Asset's routing path on Texas public roadways.  
* \[ \] **Cabin / Closure Secure:** Physical inspection and closure of an ajar exterior passenger door or trunk latch.  
* \[ \] **Scene Secure:** Deployment of MUTCD-compliant safety triangles and hazard lighting pending heavy tow retrieval by authorized Texas towing operators.
...
1. The successful generation of the Texas Optical Health Report (OHR) for TxDPS/TxDOT compliance.  
