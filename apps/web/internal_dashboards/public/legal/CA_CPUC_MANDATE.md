...
**Version:** 2026.4.0 (San Francisco Pilot \- Draft)

**Jurisdiction:** State of California / CPUC & DMV Autonomous Vehicle Deployment Program
...
* **Fleet Operator:** \[FLEET\_ID\] (e.g., WAYMO\_LLC, CRUISE\_LLC, ZOOX\_INC)  
...
This mandate grants the Agent explicit, limited authority to perform physical actions on the Asset's exterior strictly necessary to clear the following Unified Diagnostic Service (UDS) fault, in compliance with California Public Utilities Commission (CPUC) and DMV incident management guidelines:

**Active Fault Code:** \[UDS\_FAULT\_CODE\]

Authorized physical interventions are strictly limited to the PAN Service Catalog:

* ![][image1]**Optical Reclamation Protocol (ORP):** Application of PAN "HP Potion" solvent and microfiber clearance to occluded LiDAR, Radar, or Optical Domes.  
* ![][image1]**Perimeter Clear:** Removal of non-hazardous physical debris or vandalism obstructing the Asset's routing path on California public roadways.  
* ![][image1]**Cabin / Closure Secure:** Physical inspection and closure of an ajar exterior passenger door or trunk latch.  
* ![][image1]**Scene Secure:** Deployment of MUTCD-compliant safety triangles and hazard lighting pending heavy tow retrieval by authorized California towing operators or municipal transit authorities.
...
1. The successful generation of the California Optical Health Report (OHR) for CPUC/DMV compliance auditing.  
